    ...
    public function shortcode_dialog() {
        ...
        <div id="cs-shortcode-dialog" class="cs-dialog" title="<?php esc_html_e( 'Add Shortcode', 'cs-framework' ); ?>">
            <div class="cs-dialog-header">
                <select class="<?php echo ( is_rtl() ) ? 'chosen-rtl ' : ''; ?>cs-dialog-select"
                        data-placeholder="<?php esc_html_e( 'Select a shortcode', 'cs-framework' ); ?>">
                    <option value=""></option>
                    <?php
            ...
            <div class="cs-insert-button hidden">
                <a href="#"
                   class="button button-primary cs-dialog-insert"><?php esc_html_e( 'Insert Shortcode', 'cs-framework' ); ?></a>
            </div>
        </div>
        <?php
    }
